...
export default function CreateCoursePage() {
  ...
  function handleImageChange(file: File) {
    if (!file.type.startsWith("image/")) {
      setError("Only accept image files (jpg, png, webp, ...)");
      return;
    }
    setImage(file);
  ...
  function validate(): string {
    if (!form.title.trim())            return "Please enter the course title";
    if (form.title.length > 56)        return "Title max 56 characters";
    if (!form.author.trim())           return "Please enter the author name";
    if (form.author.length > 78)       return "Author name max 78 characters";
  ...
  return (
    <div className="cc-page">
      ...
      <div className="cc-header">
        ...
        <div>
          <h1 className="cc-header__title">Create a new course</h1>
          <p className="cc-header__sub">Fill in all information to publish your course</p>
        </div>
      </div>
      ...
      <div className="cc-body">
        ...
        <div className="cc-form">
          ...
          <div className="cc-section">
            <label className="cc-label"><FiUpload /> Thumbnail image <span className="cc-req">*</span></label>
            <div
            ...
            >
              {preview ? (
                ...
                <div className="cc-dropzone__placeholder">
                  ...
                  <p>Drag & drop or <span>select an image</span></p>
                  <small>JPG, PNG, WEBP — 16:9 ratio recommended</small>
                </div>
              )}
            </div>
            <input
          ...
          <div className="cc-field">
            <label className="cc-label"><FiBookOpen /> Title <span className="cc-req">*</span></label>
            <input
              className="cc-input"
              placeholder="e.g., React programming from basics to advanced"
              value={form.title}
              maxLength={56}
          ...
          {/* Sub title */}
          <div className="cc-field">
            <label className="cc-label"><FiAlignLeft /> Short description <span className="cc-req">*</span></label>
            <input
              className="cc-input"
              placeholder="e.g., Build a modern web app with React 18"
          ...
          {/* Author */}
          <div className="cc-field">
            <label className="cc-label"><FiUser /> Author / instructor <span className="cc-req">*</span></label>
            <input
              className="cc-input"
          ...
          {/* Price */}
          <div className="cc-field">
            <label className="cc-label"><FiDollarSign /> Price (VND) <span className="cc-req">*</span></label>
            <input
              className="cc-input"
              type="number"
            ...
            {form.price && !isNaN(Number(form.price)) && (
              <span className="cc-price-hint">
                Original price: {Number(form.price).toLocaleString("vi-VN")} ₫ &nbsp;·&nbsp;
                Sale price: {(Number(form.price) * 0.5).toLocaleString("vi-VN")} ₫
              </span>
            )}
          </div>
          ...
          <div className="cc-row">
            <div className="cc-field">
              <label className="cc-label"><FiGlobe /> Language</label>
          ...
          {/* Category */}
          <div className="cc-field">
            <label className="cc-label"><FiTag /> Category</label>
        ...
        <div className="cc-preview">
          <p className="cc-preview__label">Preview</p>
          <div className="cc-preview__card">
            ...
            <div className="cc-preview__body">
              <p className="cc-preview__title">{form.title || "Course title"}</p>
              <p className="cc-preview__sub">{form.courseSub || "Short description"}</p>
              <p className="cc-preview__author">{form.author || "Instructor name"}</p>
